...
export const ASTEROID_CONFIGS = {
  ...
  vite: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(46, 819) scale(1.4) rotate(0 0 0)"
      >
        <defs>
          <linearGradient
            id="a"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(225, 970) scale(1.4) rotate(180 0 0)"
      >
        <defs>
          <linearGradient
            id="a"
  ...
  webpack: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(53, 804) scale(1.5) rotate(0 0 0)"
      >
        <path
          fill="#8ed6fb"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(220, 988) scale(1.5) rotate(180 0 0)"
      >
        <path
          fill="#8ed6fb"
          d="M107.39,94.71l-49.8,28.17V100.94l31-17.07L107.39,94.7Zm3.41-3.09V32.71L92.58,43.24V81.11L110.8,91.62ZM3.41,94.71l49.8,28.17V100.94l-31-17.07L3.41,94.71ZM0,91.62V32.71L18.22,43.24V81.11L0,91.62ZM2.14,28.89,53.21,0V21.2l-32.73,18-.26.14L2.14,28.89Zm106.52,0L57.59,0V21.2l32.73,18,.26.15,18.08-10.45Z"
  ...
  vercel: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(36, 796) scale(1) rotate(0 0 0)"
      >
        <g xmlns="http://www.w3.org/2000/svg">
          <circle cx="100" cy="100" r="100" fill="white"></circle>
          <polygon
            fill="#000000"
            points="100,0       186.6,150       13.4,150"
          ></polygon>
        </g>
      </g>
    ),
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(235, 995) scale(1) rotate(180 0 0)"
      >
        <g xmlns="http://www.w3.org/2000/svg">
          <circle cx="100" cy="100" r="100" fill="white"></circle>
          <polygon
  ...
  netlify: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(39, 810) scale(1.5) rotate(0 0 0)"
      >
        <g>
          <path
            fill="#32E6E2"
          ...
          <path
            fill="#FFFFFF"
            d="M80.5,74.6h-8.8l-0.7-0.7V53.3c0-3.7-1.4-6.5-5.8-6.6c-2.3-0.1-4.9,0-7.6,0.1l-0.4,0.4v26.6l-0.7,0.7h-8.8     l-0.7-0.7V38.8l0.7-0.7h19.8c7.7,0,13.9,6.2,13.9,13.9v21.9L80.5,74.6z"
          ></path>
          <path
            fill="#32e6e2"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(231, 980) scale(1.5) rotate(180 0 0)"
      >
        <g>
          <path
            fill="#32E6E2"
  ...
  docker: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(38, 825) scale(1.6) rotate(0 0 0)"
      >
        <g>
          <path
            fill="#0091E2"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(234, 968) scale(1.6) rotate(180 0 0)"
      >
        <g>
          <path
            fill="#0091E2"
  ...
  wordpress: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(38, 798) scale(1.6) rotate(0 0 0)"
      >
        <g xmlns="http://www.w3.org/2000/svg" fill="#21759b">
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(233, 993) scale(1.6) rotate(180 0 0)"
      >
        <g xmlns="http://www.w3.org/2000/svg" fill="#21759b">
          <path d="m8.708 61.26c0 20.802 12.089 38.779 29.619 47.298l-25.069-68.686c-2.916 6.536-4.55 13.769-4.55 21.388z" />
          <path d="m96.74 58.608c0-6.495-2.333-10.993-4.334-14.494-2.664-4.329-5.161-7.995-5.161-12.324 0-4.831 3.664-9.328 8.825-9.328.233 0 .454.029.681.042-9.35-8.566-21.807-13.796-35.489-13.796-18.36 0-34.513 9.42-43.91 23.688 1.233.037 2.395.063 3.382.063 5.497 0 14.006-.667 14.006-.667 2.833-.167 3.167 3.994.337 4.329 0 0-2.847.335-6.015.501l19.138 56.925 11.501-34.493-8.188-22.434c-2.83-.166-5.511-.501-5.511-.501-2.832-.166-2.5-4.496.332-4.329 0 0 8.679.667 13.843.667 5.496 0 14.006-.667 14.006-.667 2.835-.167 3.168 3.994.337 4.329 0 0-2.853.335-6.015.501l18.992 56.494 5.242-17.517c2.272-7.269 4.001-12.49 4.001-16.989z" />
  ...
  cypress: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(40, 800) scale(2) rotate(0 0 0)"
      >
        <g>
          <path
            fill="url(#a)"
            d="m53.0123 83.2292-1.5918 3.8649c-.3163.765-1.0394 1.2831-1.853 1.3184-.5373.0202-1.0796.0352-1.627.0352-18.7354-.0099-35.3118-13.2602-39.41948-31.5178l-6.37747 1.4443C4.44847 68.6151 10.2334 77.9099 18.4337 84.5528c8.2956 6.7181 18.7456 10.427 29.4365 10.4471l.0955 0c.6276 0 1.2504-.015 1.8729-.0401 3.3544-.141 6.3524-2.2496 7.633-5.3747l2.0789-5.0525-6.5382-1.3034Z"
          />
          <path
            fill="url(#b)"
            d="M2.66721 60.4529C1.56245 56.417 1 52.2249 1 48.0028 1 28.7287 13.0669 11.1052 31.0293 4.15552l2.3551 6.11438C17.9228 16.2534 7.53814 31.4159 7.53814 48.0028c0 3.6384.48205 7.2415 1.43114 10.7138l-6.30207 1.7363Z"
          />
          <path
            fill="url(#c)"
            d="M83.8715 29.3827C76.8813 15.921 63.1222 7.5572 47.9721 7.5572c-5.3681 0-10.5855 1.03667-15.4968 3.0748l-2.5056-6.05399C35.6793 2.20777 41.7353 1 47.9721 1c17.6007 0 33.5794 9.7125 41.6993 25.3532l-5.7999 3.0295Z"
          />
          <path
            fill="#09293f"
            d="M33.947 38.3049c3.7913 0 6.8796 2.0281 8.4664 5.5658l.1255.2769 6.3674-2.169-.1357-.3271c-2.4656-6.0238-8.1449-9.768-14.8236-9.768-4.6952 0-8.5117 1.5099-11.6653 4.6098-3.1334 3.0798-4.7202 6.9548-4.7202 11.5191 0 4.5241 1.5868 8.3789 4.7202 11.4588 3.1536 3.1 6.9701 4.6097 11.6653 4.6097 6.6787 0 12.358-3.7441 14.8236-9.7629l.1357-.327-6.3774-2.1742-.1206.2869c-1.421 3.4774-4.5847 5.5558-8.4613 5.5558-2.6413 0-4.8709-.9259-6.6386-2.7477-1.7876-1.8469-2.6915-4.1668-2.6915-6.8943 0-2.7478.8838-5.0224 2.6915-6.9549 1.7626-1.8316 3.9973-2.7577 6.6386-2.7577Z"
          />
          <path
            fill="#09293f"
            d="m73.8285 32.4775-9.074 23.0332-9.1344-23.0332h-7.4722l12.8102 31.4374-9.1143 22.1726 6.5332 1.3035 22.5119-54.9135h-7.0604Z"
          />
          <path
            fill="url(#d)"
            d="M89.6715 26.353c3.3058 6.4399 5.3284 14.0039 5.3284 21.7463 0 18.0656-10.1605 33.7506-25.0617 41.6181l-3.2194-5.7089c12.9216-6.7387 21.7474-20.29 21.7474-35.9092 0-6.7779-1.6572-13.1054-4.5947-18.7167l5.8-3.0296Z"
          />
          <defs>
            <linearGradient
              id="a"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(231, 990) scale(2) rotate(180 0 0)"
      >
        <g>
          <path
            fill="url(#a)"
  ...
  mocha: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(33, 794) scale(0.4) rotate(0 0 0)"
      >
        <path
          xmlns="http://www.w3.org/2000/svg"
          d="M453,384.4L268.8,490.9c-7.9,4.6-17.7,4.6-25.6,0L59,384.4c-7.9-4.6-12.8-13.1-12.8-22V149.6c0-9.2,4.9-17.4,12.8-22L243.2,21.1c7.9-4.6,17.7-4.6,25.6,0L453,127.8c7.9,4.6,12.8,13.1,12.8,22v212.8c-0.3,9-5.1,17.4-12.8,22V384.4z"
          fill="#8D6748"
          fill-rule="evenodd"
          clip-rule="evenodd"
        />
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(238, 997) scale(0.4) rotate(180 0 0)"
      >
        <path
          xmlns="http://www.w3.org/2000/svg"
          d="M453,384.4L268.8,490.9c-7.9,4.6-17.7,4.6-25.6,0L59,384.4c-7.9-4.6-12.8-13.1-12.8-22V149.6c0-9.2,4.9-17.4,12.8-22L243.2,21.1c7.9-4.6,17.7-4.6,25.6,0L453,127.8c7.9,4.6,12.8,13.1,12.8,22v212.8c-0.3,9-5.1,17.4-12.8,22V384.4z"
  ...
  tailwind: {
    ...
    logoForward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(45, 840) scale(0.7) rotate(0 0 0)"
      >
        <defs>
          <linearGradient
            x1="-2.77777778%"
    ...
    logoBackward: (
      <g
        xmlns="http://www.w3.org/2000/svg"
        transform="translate(224, 953) scale(0.7) rotate(180 0 0)"
      >
        <defs>
          <linearGradient
            x1="-2.77777778%"
