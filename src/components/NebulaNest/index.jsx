  ...
  return (
    <div ref={containerRef} className="relative w-screen h-[800vh]">
      <svg
        ...
        className="fixed top-[5vh] left-1/2 -translate-x-1/2 h-[40vh] w-auto aspect-[16/9] opacity-0 scale-0"
      ...
      >
        ...
        {/* Main statue group */}
        <g ref={mainStatueGroupRef} transform="translate(100, 100) scale(0.85)">
          <path
      ...
      {/* Add this new message section */}
      <div
        ref={messageWrapperRef}
        className="fixed w-full h-[50vh] bottom-0 text-center opacity-0 flex items-center justify-center [perspective:1000px] [transform-style:preserve-3d] font-space-grotesk"
      >
        <div
          ref={messageRef}
